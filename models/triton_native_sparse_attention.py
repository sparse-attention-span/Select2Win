...
def native_sparse_attend(
    fq: Float['b qh n d'], # type: ignore
    fk: Float['b kh n d'], # type: ignore
    fv: Float['b kh n d'], # type: ignore
    block_size: int,
    selected_block_indices: Int['b qh n sel'] | Int['b kh n sel'], # type: ignore
    fmask: Bool['b qh n sel'] | Bool['b kh n sel'], # type: ignore
    sel_scale: Float['b kh n sel'] | Float['b qh n sel'] | None = None, # type: ignore
    include_block_causal = True,
    return_lse = False,
