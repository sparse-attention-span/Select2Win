 ...
 */
 ...
 // Fix for macOS ARM64 compatibility - match Cython's cnp.intp_t type
 #if defined(__APPLE__) && defined(__arm64__)
 using IndexType = long int;  // This matches Cython's cnp.intp_t on Apple Silicon
 #else
 using IndexType = int64_t;   // Original type for other platforms
 #endif
 using MaskType = bool;
